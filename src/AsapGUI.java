...
public class AsapGUI extends javax.swing.JFrame {

    private boolean trainAgain;
    private ArrayList<String> lastCommand;
    public AsapGUI() {
        super("ASAP: A Source Code Authorship Program");
        initComponents();
        setTrainAgain(false);
    ...
    private void initComponents() {
        ...
        scapLTextField.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                scapLTextFieldPropertyChange(evt);
            }
        });
    ...
    private boolean checkFileTextInput()
    {
    ...
    private void scapLTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scapLTextFieldActionPerformed
        try
        {
            int x = Integer.parseInt(scapLTextField.getText());
            if(x >= 500)
                scapLValue.setValue(x);
        }
        catch(Throwable t)
        {
    ...
    private void scapLTextFieldPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_scapLTextFieldPropertyChange

    }//GEN-LAST:event_scapLTextFieldPropertyChange
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsapGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
